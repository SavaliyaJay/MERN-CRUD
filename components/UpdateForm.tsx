...
const UpdateForm: React.FC = () => {
    ...
    const formik = useFormik<MyFormValues>({
        ...
        onSubmit: (values) => {
            toast.success(`${values.firstname} ${values.lastname} updated successfully!`)
        },
    });
    return (
        <>
            <form className="grid lg:grid-cols-2 w-4/6 gap-4 my-10" onSubmit={formik.handleSubmit}>
                ...
                <button className="flex justify-center text-md w-2/6 bg-blue-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500" type="submit">
                    Update <span className='px-1'>
